...
contactsList.addEventListener('click', e => {
  ...
  if (editBtn) {
    ...
    contactInputName.classList.add('form-input');
    contactInputPhone.classList.add('form-input');
    ...
    if (status === 'enabled-inputs') {
      ...
      if (NAME_REGEX.test(updatedContact.name) && PHONE_REGEX.test(updatedContact.phone)) {
